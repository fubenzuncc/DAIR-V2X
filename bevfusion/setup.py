...
if __name__ == "__main__":
    setup(
        ...
        package_data={"mmdet3dbev.ops": ["*/*.so"]},
        classifiers=[
        ...
        ext_modules=[
            ...
            make_cuda_ext(
                name="bev_pool_ext",
                module="mmdet3dbev.ops.bev_pool",
                sources=[
                    "src/bev_pool.cpp",
            ...
            make_cuda_ext(
                ...
                module="mmdet3dbev.ops.roiaware_pool3d",
                sources=[
