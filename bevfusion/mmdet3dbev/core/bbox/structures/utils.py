...
def mono_cam_box2vis(cam_box):
    ...
    # see also here: https://github.com/open-mmlab/mmdetection3d/blob/master/mmdet3dbev/datasets/nuscenes_mono_dataset.py#L557  # noqa
    dim[:, [1, 2]] = dim[:, [2, 1]]
    # change local yaw to global yaw for visualization
    # refer to https://github.com/open-mmlab/mmdetection3d/blob/master/mmdet3dbev/datasets/nuscenes_mono_dataset.py#L164-L166  # noqa
